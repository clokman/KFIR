...
# Initiates as the same with VU... The previously created vu_bibliography variable is kept untouched in order to make
# post-operation comparisons possible, in case they would be needed
...
### Write to ttl file ###
ttl_file = RDF_File('Output//vu_and_uva_merged_and_enriched_with_opencitations_v0.2.ttl')  # PATH
