...
# import input data
pybtex_import_instance = Pybtex_import("Input//UvA_Pure_100k.bib")
...
print("An output object is instantiated as the 'uva_bibliography' object.")
...
#     try:
#         uva_bibliography.setFormattedEntry(each_pybtex_entry_id, each_pybtex_entry.fields['title'],
...
for each_pybtex_entry_id, each_pybtex_entry in pybtex_data.entries.items():
    ...
    for each_argument_list in conversion_arguments_list:
        ...
        try:
            uva_bibliography.setFormattedEntry(each_pybtex_entry_id, eval(each_argument_list[0]), each_argument_list[1], each_argument_list[2])
        except KeyError:
            pass
...
pprint(uva_bibliography.entries)

print("\nFields added added to bibliography:")
pprint(uva_bibliography._field_type_registry)
