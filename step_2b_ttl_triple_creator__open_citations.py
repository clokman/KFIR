...
from step_1b_open_citations_parser import open_citations_bibliography
...
oc  =  "http://clokman.com/ontologies/open-citations#"              # assign long domain  name to short variable.
...
for each_entry_id, each_entry in open_citations_bibliography.entries.items():
