...
doi_list = []
with open('Input/all_dois_in_uva_and_vu_bibliographies_test_1k.csv', encoding='utf8') as doi_file:
...
oc_query.write_results_to_csv('Input//oc_articles_with_matching_dois.csv')

console.log_message('Open Citations query completed.', add_timestamp_in_file=True)
