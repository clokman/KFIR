...
# override automatically generated output_file_path to separate from tests in preprocessor package, which also use the
...
test_bib_file.output_file_path = 'preprocessor//test_data//problematic_characters_test_cleaned_2.bib'
